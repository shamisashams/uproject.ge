        ...
        <header class="header">
            ...
            <div class="bottom border flex">
                ...
                <div class="languages red_bg part flex center">
                    ...
                    <div class="dropdown">
                        <a class="lang {{ app()->getLocale() == 'en' ? 'on': '' }}" href="{{ route('blogIndex','en') }}">ENG</a>
                        <a class="lang {{ app()->getLocale() == 'ru' ? 'on': '' }}" href="{{ route('blogIndex','ru') }}">RUS</a>
                        <a class="lang {{ app()->getLocale() == 'ge' ? 'on': '' }}" href="{{ route('blogIndex','ge') }}">GEO</a>
                    </div>
                </div>
            </div>
        </header>
