<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
    <div class="brand-sidebar">
        <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="{{route('adminBlogIndex',app()->getLocale())}}">
{{--                <img--}}
...
{{--                    alt="materialize logo"/>--}}
                <img class="show-on-medium-and-down hide-on-med-and-up"
                    ...
                    alt="materialize logo"/>
                <span class="logo-text hide-on-med-and-down">Materialize</span></a><a
